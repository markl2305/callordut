...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A complete chamber AV system runs $50K-$200K depending on size, camera count, and broadcast requirements. Smaller council chambers are on the lower end; larger city council chambers with broadcast capability are on the higher end."
      }
    },
    {
      "@type": "Question",
...
<!-- CLIO_META {"factual_claims":[{"claim":"A complete chamber AV system runs $50K-$200K","source":"industry_range"}],"self_grade":{"word_count":1200,"schema_complete":true,"faq_count":5},"rag_used":["[1] AV Design Viewer","[3] Forge AV vertical","[6] Low-voltage estimating","[10] Low voltage estimating software"]}" -->
